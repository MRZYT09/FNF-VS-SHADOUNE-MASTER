...
class TitleState extends MusicBeatState
{
		...
		if (pressedEnter && !transitioning && skippedIntro)
		{
			...
			new FlxTimer().start(2, function(tmr:FlxTimer)
			{
				...
				http.onData = function (data:String) {
					...
					{
						trace('kade engine 1.6 zzz kade engine 1.3.1 GOD' + data.trim() + ' != ' + MainMenuState.kadeEngineVer);
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			...
			// credTextShit.screenCenter();
			case 8:
				createCoolText(['mod inspired', 'in']);
			case 9:
				addMoreText('Shadoune666');
			//credTextShit.text += '\nNewgrounds';
			case 10:
				deleteCoolText();
			...
			case 19:
				addMoreText('VS SHADOUNE'); // credTextShit.text += '\nVSshadoune';

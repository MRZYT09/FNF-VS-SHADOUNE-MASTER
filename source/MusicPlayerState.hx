...
class MusicPlayerState extends MusicBeatState
{
    ...
    override function create()
    {
        ...
        bg = new FlxSprite().loadGraphic(Paths.image('backgrounds/BG5'));
       ...
       //bg.color = 0xFFE62F2F;
		...
		barText.setFormat(Paths.font("minecraftia.ttf"), 16, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE,FlxColor.BLACK);
